...
function changeQuotes() {
  var quotesSize = Object.keys(quotes).length
  let valueRandom = Math.floor(Math.random() * quotesSize)
  quote.textContent = quotes[valueRandom].quote
  author.textContent = quotes[valueRandom].author
}